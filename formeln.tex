...
\newcommand{\mydoubleeqarrow}[2]{\begin{align*}\boxed{#1} & \hfill & {\Large \rightarrow} & \hfill & \boxed{#2}\end{align*}}
...
\bmyeq{\sum_{k=0}^\infty \frac{a}{b^k} = \frac{ab}{b-1} \text{ (für }|b|>1\text{)}}

\bmyeq{\sum_{k=0}^\infty \frac{a^{k+1}}{b^k} = \frac{ab}{b-a} \text{ (für }|a|<|b|\text{)}}
...
\bmyeq{\sin\left(\frac{\pi}{2}\right) =1}

\mysubsection{Induktion Folge}

$a_{n+1}$ ist beschränkt durch 0 und 1. Zu zeigen: $$ 0 < 1 - a_{n+1} < 1 $$
